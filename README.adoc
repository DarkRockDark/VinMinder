...
```
// The app will take some time to spin up if it has not been accessed recently.
// Swagger:
// https://vinminder.herokuapp.com/swagger-ui.html#/
// Vehicles currently in repository can be seen here:
// https://vinminder.herokuapp.com/vehicle
...
https://mlab.com/databases/vinminder/collections/vehicles
```
the next section is the stuff from Spring.io
